(module $basic-0a45c42a391e176b.wasm
  ...
  (func $_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$11finish_grow17hb61ecc0d932073e2E (;3;) (type 3) (param i32 i32 i32 i32)
  ...
  (func $_ZN4core6result13unwrap_failed17hf1b7344c4a305aa0E (;4;) (type 4) (param i32)
    call $_ZN4core9panicking9panic_fmt17hcb6b2b4be1f4be38E
    unreachable
  )
  (func $_ZN4core9panicking9panic_fmt17hcb6b2b4be1f4be38E (;5;) (type 2)
    unreachable
  )
  (func $js_sys.externref.next (;6;) (type 5) (result i32)
    (local i32 i32)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
  ...
  (func $js_sys.is_nan (;7;) (type 5) (result i32)
    call $js_sys.import.is_nan
    call $js_sys.externref.insert
  )
  (func $js_sys.externref.grow (;8;) (type 6) (param i32) (result i32)
    ref.null extern
    local.get 0
    table.grow 0
  )
  (func $js_sys.externref.insert (;9;) (type 7) (param externref) (result i32)
    (local i32)
  ...
  (func $js_sys.externref.get (;10;) (type 8) (param i32) (result externref)
    local.get 0
    table.get 0
  )
  (func $js_sys.externref.remove (;11;) (type 4) (param i32)
    local.get 0
    ref.null extern
    table.set 0
  )
  (func $web_sys.console.log (;12;) (type 4) (param i32)
    local.get 0
