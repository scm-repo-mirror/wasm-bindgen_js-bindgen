(module $basic-2be9113d34cbacad.wasm
  ...
  (func $foo (;5;) (type 2)
    ...
    local.get 0
    call $_ZN57_$LT$js_sys..JsValue$u20$as$u20$core..ops..drop..Drop$GT$4drop17h36317a40048f97e9E
    i32.const 1048589
    i32.const 5
    call $js_sys.string_decode
    local.tee 0
  ...
  (func $_ZN57_$LT$js_sys..JsValue$u20$as$u20$core..ops..drop..Drop$GT$4drop17h36317a40048f97e9E (;6;) (type 4) (param i32)
  ...
  (func $_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$11finish_grow17h8a3382b4d7970919E (;9;) (type 5) (param i32 i32 i32 i32)
    (local i32 i32 i32 i32)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
